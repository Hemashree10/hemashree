...
dateELE.addEventListener("change", () => {
  ...
  dateELE.style.border = "1px solid rgba(0, 0, 0, 1)";
  if (age < 18 || age > 60) {
    dateELE.setCustomValidity("Your age does not lie between 18 and 60");
    dateELE.style.border = "2.5px solid red";
    return;
  } else {
...
function validate(ele) {
  if (ele.validity.typeMismatch) {
    ele.setCustomValidity("The Email is not in the right format.please check the format you have entered");
    ele.reportValidity();
  } else {
